...
Place the provider against the Empowerer and encode the recipe as a pattern.
...
The adapter places the base item on the Empowerer and the four modifiers on the stands, then lets the
