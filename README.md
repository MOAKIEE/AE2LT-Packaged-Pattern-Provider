...
- Optional-mod reflection handling is only partially unified so far. Existing adapters still use guarded reflection helpers; new hot-path adapters should prefer `MethodHandle`-based helpers where it keeps optional-mod failure handling simple.
